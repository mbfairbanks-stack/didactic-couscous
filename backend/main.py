...
@app.get("/retirement/profiles", response_model=list[RetirementProfileOut])
...
@app.post("/retirement/profiles", response_model=RetirementProfileOut, status_code=201)
...
@app.put("/retirement/profiles/{profile_id}", response_model=RetirementProfileOut)
...
@app.delete("/retirement/profiles/{profile_id}", status_code=204)
...
@app.get("/retirement/rsu-grants", response_model=list[RsuGrantOut])
...
@app.post("/retirement/rsu-grants", response_model=RsuGrantOut, status_code=201)
...
@app.put("/retirement/rsu-grants/{grant_id}", response_model=RsuGrantOut)
...
@app.delete("/retirement/rsu-grants/{grant_id}", status_code=204)
...
@app.get("/retirement/retention-bonuses", response_model=list[RetentionBonusOut])
...
@app.post("/retirement/retention-bonuses", response_model=RetentionBonusOut, status_code=201)
...
@app.put("/retirement/retention-bonuses/{bonus_id}", response_model=RetentionBonusOut)
...
@app.delete("/retirement/retention-bonuses/{bonus_id}", status_code=204)
...
@app.get("/retirement/goals", response_model=list[RetirementGoalOut])
...
@app.post("/retirement/goals", response_model=RetirementGoalOut, status_code=201)
...
@app.put("/retirement/goals/{goal_id}", response_model=RetirementGoalOut)
...
@app.delete("/retirement/goals/{goal_id}", status_code=204)
